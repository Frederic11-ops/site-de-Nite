...
function afficher(){
        ...
        ['Discutir','7.jpg','Discuter','Ce qui fait la particularité de Nit, ce n’est pas seulement son élégance naturelle ou sa fidélité sans faille, mais surtout sa curieuse passion pour la discussion avec les humains. On dirait qu’elle a compris depuis longtemps que les mots ne sont pas nécessaires pour établir un dialogue sincère. Chaque intonation, chaque silence et chaque geste deviennent pour elle des occasions d’échanger. Son museau attentif, ses oreilles dressées et ses yeux pleins d’intelligence semblent demander : « Et toi, que penses-tu ? ». Nit n’écoute pas seulement, elle répond à sa manière. Par des aboiements doux, des mimiques ou même un simple battement de queue, elle donne l’impression de participer pleinement à la conversation. Beaucoup de ceux qui la rencontrent repartent avec la sensation d’avoir été réellement compris, comme si Nit possédait ce talent rare de se glisser dans l’âme des gens.' ]
        ];
